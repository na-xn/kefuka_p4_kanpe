  ...
  it("GC role resolveSec: 視線 GC1=51, 視線 GC2=74", () => {
    ...
    const setupShisenGC1: SimSetup = {
      ...
      players: [
        ...
        { seat: 1, role: "TH", job: "tank", gc1Role: "mushoku", gc2Role: "rai", gc3Role: "aragan", gc3Scar: "seija" },
        { seat: 2, role: "TH", job: "healer", gc1Role: "mizu", gc2Role: "shisen", gc3Role: "aragan", gc3Scar: "seija" },
        { seat: 3, role: "TH", job: "healer", gc1Role: "rai", gc2Role: "mushoku", gc3Role: "aragan", gc3Scar: "seija" },
        { seat: 4, role: "DPS", job: "dps", gc1Role: "shisen", gc2Role: "mizu", gc3Role: "shi", gc3Scar: "shisha" },
        { seat: 5, role: "DPS", job: "dps", gc1Role: "mushoku", gc2Role: "rai", gc3Role: "shi", gc3Scar: "shisha" },
        { seat: 6, role: "DPS", job: "dps", gc1Role: "mizu", gc2Role: "shisen", gc3Role: "shi", gc3Scar: "shisha" },
        { seat: 7, role: "DPS", job: "dps", gc1Role: "rai", gc2Role: "mushoku", gc3Role: "shi", gc3Scar: "shisha" },
      ],
    };
  ...
  it("GC role resolveSec: 無職 GC1=74, 無職 GC2=51", () => {
    ...
    const setupMushokuGC1: SimSetup = {
      ...
      players: [
        ...
        { seat: 1, role: "TH", job: "tank", gc1Role: "shisen", gc2Role: "rai", gc3Role: "aragan", gc3Scar: "seija" },
        { seat: 2, role: "TH", job: "healer", gc1Role: "mizu", gc2Role: "shisen", gc3Role: "aragan", gc3Scar: "seija" },
        { seat: 3, role: "TH", job: "healer", gc1Role: "rai", gc2Role: "mushoku", gc3Role: "aragan", gc3Scar: "seija" },
        { seat: 4, role: "DPS", job: "dps", gc1Role: "mushoku", gc2Role: "mizu", gc3Role: "shi", gc3Scar: "shisha" },
        { seat: 5, role: "DPS", job: "dps", gc1Role: "shisen", gc2Role: "rai", gc3Role: "shi", gc3Scar: "shisha" },
        { seat: 6, role: "DPS", job: "dps", gc1Role: "mizu", gc2Role: "shisen", gc3Role: "shi", gc3Scar: "shisha" },
        { seat: 7, role: "DPS", job: "dps", gc1Role: "rai", gc2Role: "mushoku", gc3Role: "shi", gc3Scar: "shisha" },
      ],
    };
    ...
    const setupMushokuGC2: SimSetup = {
      ...setupMushokuGC1,
      players: [
        { seat: 0, role: "TH", job: "tank", gc1Role: "mizu", gc2Role: "mushoku", gc3Role: "aragan", gc3Scar: "seija" },
        { seat: 1, role: "TH", job: "tank", gc1Role: "rai", gc2Role: "shisen", gc3Role: "aragan", gc3Scar: "seija" },
        { seat: 2, role: "TH", job: "healer", gc1Role: "shisen", gc2Role: "mizu", gc3Role: "aragan", gc3Scar: "seija" },
        { seat: 3, role: "TH", job: "healer", gc1Role: "mushoku", gc2Role: "rai", gc3Role: "aragan", gc3Scar: "seija" },
        { seat: 4, role: "DPS", job: "dps", gc1Role: "mizu", gc2Role: "mushoku", gc3Role: "shi", gc3Scar: "shisha" },
        { seat: 5, role: "DPS", job: "dps", gc1Role: "rai", gc2Role: "shisen", gc3Role: "shi", gc3Scar: "shisha" },
        { seat: 6, role: "DPS", job: "dps", gc1Role: "shisen", gc2Role: "mizu", gc3Role: "shi", gc3Scar: "shisha" },
        { seat: 7, role: "DPS", job: "dps", gc1Role: "mushoku", gc2Role: "rai", gc3Role: "shi", gc3Scar: "shisha" },
      ],
    };
